...
define(['./Transforms-b2c3e401', './BoxGeometry-6b79e907', './Cartesian2-e9bb1bb3', './Color-02b2e665', './CylinderGeometry-72ac91c0', './when-208fe5b0', './EllipsoidGeometry-0b7a309b', './IndexDatatype-4d4b60a0', './createTaskProcessorWorker', './Check-5e798bbf', './Math-56f06cd5', './RuntimeError-7f634f5d', './GeometryOffsetAttribute-6fce6185', './ComponentDatatype-b3120730', './WebGLConstants-76bb35d1', './GeometryAttribute-dddfbf98', './GeometryAttributes-b0b294d8', './VertexFormat-9eeda9f8', './CylinderGeometryLibrary-2189d3bf'], function (Transforms, BoxGeometry, Cartesian2, Color, CylinderGeometry, when, EllipsoidGeometry, IndexDatatype, createTaskProcessorWorker, Check, _Math, RuntimeError, GeometryOffsetAttribute, ComponentDatatype, WebGLConstants, GeometryAttribute, GeometryAttributes, VertexFormat, CylinderGeometryLibrary) { 'use strict';
